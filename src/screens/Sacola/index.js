    ...
    if (!showCheckout) {
        ...
        return (
            <View style={{ flex: 1, justifyContent: 'center' }}>
                ...
                <WebView
                    source={{ uri: `https://3333-ff3d134b-c240-432b-ae3f-14f6526cdc1f.ws-us02.gitpod.io/payments/checkout/${idPagamento}/${emailPagamento}/${descricaoPagamento}/${vlrPagamento}` }}
